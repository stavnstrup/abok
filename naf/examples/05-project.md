...
-   Context and constraints of the project, in particular, the links
...
![](media/image56.png) Figure : Zones of the Grid used to establish project architecture landscape
...
3.  A synthetic narrative of the vision
...
![](media/image58.png) Figure : Zones of the Grid used in the Establish Architecture Vision Stage at Project level
...
![](media/image59.jpeg) Figure : Example Architecture Concept for the project architecture

![](media/image60.jpeg) Figure : Example of L3 View for the project architecture

![](media/image61.jpeg) Figure : Example L4 View for the project architecture

![](media/image62.jpeg) Figure : Example of S1View for the Project architecture

# Describe Alternatives Architectures


![](media/image63.png) XXX
...
![](media/image64.png) Figure : Zones of the Grid used in the Describe Alternatives Architectures Stage at Project level
...
![](media/image65.jpeg) Figure : L4 diagram of the SAR process

![](media/image66.jpeg) Figure : Diagram P2 of the Yellow sites of the Yellow Search and Rescue System

![](media/image67.jpeg) Figure :

![](media/image68.jpeg) Figure 64:

# Evaluate Alternatives of Architecture and propose a trade-off

![](media/image69.png) XXX
...
![](media/image70.png) Figure : Zones of the Grid used in the Evaluate Alternatives Architecture and get trade-off Stage at Project level
  ...
  S6 Service Interactions               NSOV-4, Service Orchestration
...
![](media/image71.png) Figure : Zones of the Grid used in the Plan Migration Stage at Project level
...
![](media/image73.png) Figure 67: Zones of the Grid used in the Govern Application of Architecture Stage at Project level
...
<li><p>Architecture updates</p></li>
...
![](media/image75.png) Figure 68: Zones of the Grid used in the Decide on architecture change Stage at Project level
...
![](media/image77.png) Figure 69: Grid elements for Manage project Architecture, Dashboards and Motivation Data
